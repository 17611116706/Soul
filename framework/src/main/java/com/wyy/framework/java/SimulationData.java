package com.wyy.framework.java;
...
public class SimulationData {
    ...
    private static void testData(String phone, String nickName, String photoUrl, boolean sex, String desc, int age, String birthday, String constellation, String hobby, String status) {
        ...
        imUser.setTokenPhoto(photoUrl);

        imUser.setUsername(phone);
        imUser.setPassword("123456");

        imUser.setNickName(nickName);
        imUser.setPhoto(photoUrl);
        imUser.setSex(sex);
        imUser.setDesc(desc);

        imUser.setMobilePhoneNumber(phone);
        ...
        imUser.signUp(new SaveListener<String>() {
            @Override
